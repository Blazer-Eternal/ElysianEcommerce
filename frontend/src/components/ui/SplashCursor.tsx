...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    const getWebGLContext = (canvas: HTMLCanvasElement) => {
      ...
      const isWebGL2 = !!gl;
      if (!isWebGL2)
        gl = canvas.getContext('webgl', params as any) || canvas.getContext('experimental-webgl', params as any);
    ...
    const compileShader = (type: any, source: string, keywords?: any[]) => {
      const addKeywords = (source: string, keywords?: any[]): string => {
    ...
    const blit = (() => {
      ...
      return (target: any, clear?: boolean) => {
        if (target == null) {
    ...
    const resizeFBO = (target: any, w: number, h: number, internalFormat: any, format: any, type: any, param: any) => {
    ...
    const resizeDoubleFBO = (target: any, w: number, h: number, internalFormat: any, format: any, type: any, param: any) => {
    ...
    const updatePointerUpData = (pointer: any) => {
      pointer.down = false;
    };
